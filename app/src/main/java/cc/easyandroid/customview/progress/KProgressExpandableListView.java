...
import cc.easyandroid.customview.pulltorefresh.expandablelistview.KExpandableListView;

public class KProgressExpandableListView extends KExpandableListView {
	public static final String TAG = KProgressExpandableListView.class.getName();
	private View mLoadingView;
	private View mEmptyView;
	private View mErrorView;
	private boolean isInited;;

	public KProgressExpandableListView(Context context, AttributeSet attrs) {
		// R.attr.kProgressListViewStyle从系统中获取样式
		this(context, attrs, R.attr.kProgressListViewStyle);
	}

	public KProgressExpandableListView(Context context) {
		this(context, null);
	}

	public KProgressExpandableListView(Context context, AttributeSet attrs, int defStyle) {
